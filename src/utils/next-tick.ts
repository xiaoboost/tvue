...
let microTimerFunc: func;
let macroTimerFunc: func;
 ...
 */
export function withMacroTask(fn: funcWithTask): Function {
    ...
    callbacks.push(() => {
        if (cb) {
            try {
                ...
                handleError(e, undefined, 'nextTick');
            }
        }
        else if (_resolve) {
            _resolve(ctx);
